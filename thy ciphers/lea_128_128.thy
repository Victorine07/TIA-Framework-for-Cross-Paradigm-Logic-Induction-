...
text \<open>
  LEA-128/128 specification (128-bit block, 128-bit key, 24 rounds),
  matching the Python reference implementation and the official LEA paper.
\<close>


definition lea_128_128_word_size :: nat where
  "lea_128_128_word_size = 32"

definition lea_128_128_rounds :: nat where
  "lea_128_128_rounds = 24"

definition lea_128_128_m :: nat where
  "lea_128_128_m = 4"  (* number of key words *)

(* Full LEA delta table (8 constants); LEA-128 uses delta[i mod 4] *)
...
termination
  by (relation "measure (\<lambda>(T, i, acc). lea_128_128_rounds - i)") auto
...
| "lea_128_128_encrypt_iter st (rk # rks) =
     lea_128_128_encrypt_iter (lea_128_128_encrypt_round st rk) rks"

fun lea_128_128_decrypt_iter ::
  "32 word list \<Rightarrow> 32 word list list \<Rightarrow> 32 word list" where
  "lea_128_128_decrypt_iter st rks =
     foldl lea_128_128_decrypt_round st (rev rks)"


definition lea_128_128_block_to_words :: "128 word \<Rightarrow> 32 word list" where
  "lea_128_128_block_to_words block =
    [ ucast block,
...
definition lea_128_128_words_to_block :: "32 word list \<Rightarrow> 128 word" where
  "lea_128_128_words_to_block words =
...
definition lea_128_128_encrypt_block ::
  ...
  "lea_128_128_encrypt_block plaintext rks = (
    ...
    in lea_128_128_words_to_block res)"
